...
var mac =__etcpack__scope_args__.default;
 // 兼容文件
...
window.__etcpack__bundleSrc__['4']=function(){
    var __etcpack__scope_bundle__={};
    var __etcpack__scope_args__;
    __etcpack__scope_bundle__.default= "/*\n  @author 你好2007\n  2020年6月8日于大同\n*/\n html{\n\nfont-size: 100px;\n\n}\n\n body{\n\nfont-size: .16rem;\n\n}\n\n ::-webkit-scrollbar{\n\nwidth: 0rem;\n\nheight: 0rem;\n\nbackground-color: #eee;\n\ncursor: pointer;\n\n}\n\n ::-webkit-scrollbar-thumb{\n\nheight: .3rem;\n\nbackground-color: #adadad;\n\nborder-radius: .05rem;\n\n}\n\n :hover::-webkit-scrollbar{\n\nwidth: .1rem;\n\nheight: .1rem;\n\n}\n\n/* // 失去光标特殊样式 */\n\n body.notFocus div.view>.menu{\n\nbackground-color: #e6e2ec;\n\n}\n\n body.notFocus div.view>.bottom{\n\nbackground-color: #9c86bd;\n\n}\n"
  
    return __etcpack__scope_bundle__;
}

/*************************** [bundle] ****************************/
// Original file:./src/style/mac.scss
/*****************************************************************/
window.__etcpack__bundleSrc__['5']=function(){
    var __etcpack__scope_bundle__={};
    var __etcpack__scope_args__;
    __etcpack__scope_bundle__.default= "\n body[system='mac'] div.view>.menu>.title{\n\npadding-left: .9rem;\n\nbackground-position: .5rem center;\n\n}\n\n/* // 关闭、最小化等窗口按钮样式修改 */\n\n body[system='mac'] div.view>.menu>.winBtn{\n\nleft: 0;\n\nwidth: 70px;\n\nz-index: 10;\n\n}\n\n body[system='mac'] div.view>.menu>.winBtn ul{\n\nposition: relative;\n\nmargin-left: 25px;\n\nheight: 30px;\n\n}\n\n body[system='mac'] div.view>.menu>.winBtn ul:hover>li.quit{\n\nbackground-position-x: -1px;\n\n}\n\n body[system='mac'] div.view>.menu>.winBtn ul:hover>li.minimize{\n\nbackground-position-x: 369px;\n\n}\n\n body[system='mac'] div.view>.menu>.winBtn ul>li{\n\nwidth: .2rem;\n\nbackground-image: url(./image/win-btn@mac.png);\n\n}\n\n body[system='mac'] div.view>.menu>.winBtn ul>li:hover{\n\nbackground-color: #0000;\n\n}\n\n body[system='mac'] div.view>.menu>.winBtn ul>li.quit{\n\nbackground-position-x: -225px;\n\nposition: absolute;\n\nleft: -21px;\n\n}\n\n body[system='mac'] div.view>.menu>.winBtn ul>li.minimize{\n\nbackground-position-x: 77px;\n\n}\n"
...
var uiWinBtn =__etcpack__scope_args__.default;
 // 指令
...
var _class = (_dec = Module({
  declarations: [AppComponent, uiWinBtn, uiBind, uiModel, uiOn, uiLazy],
  imports: [],
  exports: [],
...
var _class = (_dec = Component({
  ...
  function _class2() {
    ...
    _defineProperty(this, "notFocus", void 0);
  }
  ...
  _createClass(_class2, [{
    ...
    value: function $mounted() {
      ...
      this.loadPage(null);
      globalThis.nodeRequire('electron').ipcRenderer // 监听到窗口失去焦点
      .on("browser-window-blur", function () {
        _this.notFocus = true;
      }) // 监听到窗口获得焦点
      .on("browser-window-focus", function () {
        _this.notFocus = false;
      });
    }
  }, {
    key: "loadPage",
...
window.__etcpack__bundleSrc__['22']=function(){
    var __etcpack__scope_bundle__={};
    var __etcpack__scope_args__;
    __etcpack__scope_bundle__.default= "<div class='view'>\n    <div class=\"menu\" ui-bind:not-focus=\"notFocus?'yes':'no'\">\n        <div class=\"title\" style=\"-webkit-app-region: drag\">\n            计算机助手\n        </div>\n        <div class=\"winBtn\" style=\"-webkit-app-region: no-drag\">\n            <ui-win-btn></ui-win-btn>\n        </div>\n        <div class=\"nav\" style=\"-webkit-app-region: drag\">\n            <ul style=\"-webkit-app-region: no-drag\">\n                <li tag=\"home\" ui-on:click=\"loadPage\" ui-bind:active=\"currentPage.name=='home'?'yes':'no'\">启动页</li>\n                <li tag=\"tool\" ui-on:click=\"loadPage\" ui-bind:active=\"currentPage.name=='tool'?'yes':'no'\">工具箱</li>\n            </ul>\n        </div>\n    </div>\n    <div class=\"content\" ui-lazy='currentPage.value'></div>\n</div>\n"
  
    return __etcpack__scope_bundle__;
}

/*************************** [bundle] ****************************/
// Original file:./src/App/lazy-load.ts
/*****************************************************************/
window.__etcpack__bundleSrc__['23']=function(){
    ...
    __etcpack__scope_bundle__.default= {
  home: function home() {
    return window.__etcpack__getLazyBundle('./build/main-bundle1.js','24');
  },
  tool: function tool() {
    return window.__etcpack__getLazyBundle('./build/main-bundle2.js','25');
  }
};
...
/*************************** [bundle] ****************************/
// Original file:./src/component/ui-win-btn/index.ts
/*****************************************************************/
...
/*************************** [bundle] ****************************/
// Original file:./src/component/ui-win-btn/index.scss
/*****************************************************************/
...
/*************************** [bundle] ****************************/
// Original file:./src/component/ui-win-btn/index.html
/*****************************************************************/
window.__etcpack__bundleSrc__['28']=function(){
    var __etcpack__scope_bundle__={};
    var __etcpack__scope_args__;
    __etcpack__scope_bundle__.default= "<ul>\n    <li class=\"minimize\" ui-on:click=\"minimize\">最小化</li>\n    <li class=\"quit\" ui-on:click='quit'>关闭</li>\n</ul>\n"
